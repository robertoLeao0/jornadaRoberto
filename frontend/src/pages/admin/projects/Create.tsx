...
import { toast } from 'react-toastify'; // <--- 1. IMPORTANTE: Importar o toast
...
export default function CreateTask() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (response.ok) {
        // --- 2. MUDANÇA AQUI: Mensagem de Sucesso Bonita ---
        toast.success('Tarefa criada com sucesso!'); 
        
        // Volta para a lista de tarefas
        navigate('/dashboard/admin/projects'); 
      } else {
        // --- 3. MUDANÇA AQUI: Mensagem de Erro ---
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div className="flex flex-col justify-end">
             <label className="block text-sm font-medium text-gray-700 mb-2">Status da Tarefa</label>
